    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('logDate', models.DateTimeField(null=True, verbose_name='登录日期时间')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('forbiddenType', models.CharField(max_length=16, null=True)),
                ...
                ('searchHistoryUuid', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='searchUserUuid', to='manager.SearchHistory', to_field='uuid')),
            ],
            options={
                'db_table': 'tb_user',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('templateUuid', models.CharField(max_length=10, null=True)),
        ...
        migrations.AddField(
            ...
            name='worksUuid',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='worksViewpagerUuid', to='manager.Works', to_field='uuid'),
        ),
        migrations.AddField(
            model_name='user',
            name='versionUuid',
