# Generated by Django 2.1.8 on 2019-06-21 01:52
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent', models.ForeignKey(db_column='parent_id', null=True, on_delete=django.db.models.deletion.CASCADE, to='manager.Tag')),
            ],
            options={
                'db_table': 'tb_tag',
            },
        ...
        migrations.AddField(
            ...
            name='followed',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='followed', to='manager.User'),
        ),
        migrations.AddField(
            model_name='friendship',
            name='follower',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='follower', to='manager.User'),
        ),
        migrations.AddField(
            model_name='feedback',
            name='userUuid',
